...
#[Fillable([
    ...
    'legacy_postmark_message_stream_id',
    'legacy_email_provider',
...
TEXT;
    ...
    protected $casts = [
        ...
        'legacy_postmark_token' => 'encrypted',
        'legacy_twilio_auth_token' => 'encrypted',
        'legacy_twilio_api_key_secret' => 'encrypted',
        'legacy_partstech_api_key' => 'encrypted',
        'legacy_partstech_password' => 'encrypted',
        'legacy_openai_api_key' => 'encrypted',
