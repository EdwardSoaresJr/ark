...
/**
 * Settings → ARK Cloud service list.
 *
 * Box connection state is local (CloudConnection). Managed-service rows come
 * from ARK Cloud when connected — Core renders; Cloud is authority.
 */
final class ArkCloudServiceCatalog
{
    public function __construct(
        private readonly ShopSettings $settings,
        private readonly CloudConnection $cloud,
        private readonly CloudStatusClient $statusClient,
    ) {}
    ...
    public function services(): array
    {
        ...
        if ($status === null) {
            return [[
                ...
                'detail' => 'Could not load service status from ARK Cloud.',
