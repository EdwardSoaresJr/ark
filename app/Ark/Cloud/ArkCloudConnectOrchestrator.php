 ...
 */
final class ArkCloudConnectOrchestrator
{
    ...
    public function pollAndClaim(): array
    {
        ...
        if ($status === 'approved_awaiting_box_claim') {
            ...
            return [
                'status' => 'connected',
                'shop_public_id' => CloudConnection::current()->shopPublicId(),
                'connected' => true,
            ];
        }
        ...
        if ($status === 'connected') {
            ...
            return [
                'status' => CloudConnection::current()->isConnected() ? 'connected' : 'pending',
                'shop_public_id' => CloudConnection::current()->shopPublicId(),
                'connected' => CloudConnection::current()->isConnected(),
            ];
        }
